...
import Controller.Produto.AlteraProduto;
import Controller.Produto.BuscaProduto;
import Controller.Produto.ExcluiProduto;
import Controller.Produto.IncluiProduto;
...
public class FrameProduto extends javax.swing.JFrame {
    ...
    private void tfBuscarFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_tfBuscarFocusLost
        // TODO add your handling code here:
        try {
            Produto produto = BuscaProduto.Buscar(tfBuscar.getText());
    ...
    private void btnListarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnListarActionPerformed
        try {
            // TODO add your handling code here:
            List<Produto> lista = BuscaProduto.Listar();
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        try {
            ExcluiProduto.Excluir(produtoId);
            btnLimparActionPerformed(evt);
        } catch (SQLException ex) {
            Logger.getLogger(FrameProduto.class.getName()).log(Level.SEVERE, null, ex);
        }
